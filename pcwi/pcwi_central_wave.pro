; $Id: pcwi_central_wave.pro | Tue Mar 3 16:16:17 2015 -0800 | Don Neill  $
;
...
;
; PURPOSE:
;	Given the grating installed in PCWI and camera articulation
...
;
; CALLING SEQUENCE:
;	Result = PCWI_CENTRAL_WAVE(Grating,Stage_Position,/DISPLAY)
;
; INPUTS:
;       Grating		- String value identifying the installed PCWI grating, 
;				either "RED", "YELLOW", or "BLUE"
;       Stage_Position	- Integer value indicating the PCWI
...
; EXAMPLE:
;
;      wave = pcwi_central_wave("blue",1000000)
;
...
;-
function pcwi_central_wave, grating, stage_position, grat_position, $
                           display = display, $
                           help=help

pre = 'PCWI_CENTRAL_WAVE'
wave = -1.
