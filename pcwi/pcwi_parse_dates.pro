; $Id: pcwi_parse_dates.pro | Tue Mar 3 16:16:17 2015 -0800 | Don Neill  $
;
...
;
; CALLING SEQUENCE:
;	Result = PCWI_PARSE_DATES( HDR_DATES )
;
; INPUTS:
...
;-
function pcwi_parse_dates,hdr_dates,verbose=verbose
;
; initialize
	pre = 'PCWI_PARSE_DATES'
;
; set up output array
