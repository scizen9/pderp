; $Id: pcwi_cfg__define.pro | Tue Mar 3 16:16:17 2015 -0800 | Don Neill  $
;
...
;	information for PCWI raw data read from the raw headers.
;
; CATEGORY:
...
;
; SIDE EFFECTS:
;	defines the PCWI_CFG data structure
;
; PROCEDURE:
;	Provide the automatic structure definition for the PCWI raw header
;	observation structure PCWI_CFG.
;
; EXAMPLE:
;	Instantiate and initialize a single cfg struct for PCWI:
;
;	pcfg = {pcwi_cfg}
;	pcfg = struct_init(pcfg)
;
; NOTES:
...
;-
pro pcwi_cfg__define
;
tmp = { pcwi_cfg, $
;
; Observation properties
	observer:'', $		; observer
	telescop:'Hale5m', $	; telescope
	instrume:'PCWI', $	; instrument
	object:'', $		; object name
