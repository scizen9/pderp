; $Id: pcwi_gratanom.pro | Tue Mar 3 16:16:17 2015 -0800 | Don Neill  $
;
...
;
; CALLING SEQUENCE:
;       Result = PCWI_GRATANOM(Grating, Grating_Position, Central_Wavelength)
;
; INPUTS:
...
;				from pcwi_central_wave.pro
;
; RETURNS:
;	Grating anomoly in degrees.
;
; EXAMPLE:
;	IDL> print,pcwi_gratanom('BLUE',5470,4983.0)
;		 -2.5059096
;	IDL> print,pcwi_gratanom('BLUE',-3005,5104.0)
;		0.013733995
;
...
;- 
function pcwi_gratanom,gratid,gratpos,wavelength
;
; setup
pre='PCWI_GRATANOM'
version = repstr('$Revision: ca58c78 $ $Date: Tue Mar 3 16:16:17 2015 -0800 $','$','')
;
