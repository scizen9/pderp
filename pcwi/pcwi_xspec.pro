; $Id: pcwi_xspec.pro | Fri Apr 24 15:25:00 2015 -0700 | Don Neill  $
;
...
;
; CALLING SEQUENCE:
;	PCWI_XSPEC, Spec0, Spec1, Ppar, Offset, Value
;
; INPUTS:
...
;-
pro pcwi_xspec, spec0, spec1, ppar, offset, value, $
...
if keyword_set(plot) and ppar.display ge 3 then begin
	...
	pcwi_legend,['Spec0','Spec1'],charsi=1.5,charthi=2,thick=[2,2], $
