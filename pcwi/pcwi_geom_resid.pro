;-
; $Id: pcwi_geom_resid.pro | Wed Mar 4 12:02:01 2015 -0800 | Don Neill  $
;
...
;	pcwi_geom_resid,xi,yi,xw,yw,3,kwx,kwy,xrsd,yrsd
;	!p.multi=[0,1,2]
;	plot,xi,xrsd,psym=4
;	plot,yi,yrsd,psym=4
;
...
;-
;
pro pcwi_geom_resid,xi,yi,xw,yw,degree,kwx,kwy,xrsd,yrsd
;
; setup
pre = 'PCWI_GEOM_RESID'
xrsd = -1.
