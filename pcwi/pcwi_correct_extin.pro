; $Id: pcwi_correct_extin.pro | Wed Mar 4 12:02:01 2015 -0800 | Don Neill  $
;
...
;
; CALLING SEQUENCE:
;	PCWI_CORRECT_EXTIN, Img, Hdr, Ppar
;
; INPUTS:
...
;-
pro pcwi_correct_extin,img,hdr,ppar
;
; setup
pre = 'PCWI_CORRECT_EXTIN'
;
; get airmass
...
;
; get Palomar extinction coefficients
if strpos(telescope,'Palomar') ge 0 then begin
;
...
;	exma - extinction in magnitudes per airmass
	...
	pcwi_print_info,ppar,pre,'No extinction curve for telescope', $
