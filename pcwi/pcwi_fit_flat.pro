; $Id: pcwi_fit_flat.pro | Wed Mar 4 12:02:01 2015 -0800 | Don Neill  $
;
...
;
; CALLING SEQUENCE:
;	PCWI_FIT_FLAT, Img, Hdr, Ppar, Flat
;
; INPUTS:
...
;-
pro pcwi_fit_flat,img,hdr,ppar,flat,splord=splord
	;
	; initialize
	pre = 'PCWI_FIT_FLAT'
	q = ''
	...
	;
	; log
	pcwi_print_info,ppar,pre,'Spline order, y0, y1',splo,y0,y1, $
			format='(a,3i5)'
	;
