;$Id: pcwi_fix_headers.pro | Tue Mar 3 16:45:54 2015 -0800 | Don Neill  $
;
...
;
; PURPOSE:
;	Fix PCWI raw image data headers to work with PCWI DRP.
;
; CATEGORY:
;	Data reduction for the Palomar Cosmic Web Imager (PCWI).
;
; CALLING SEQUENCE:
;	PCWI_FIX_HEADERS,Hmf
;
; OPTIONAL INPUTS:
...
;
;	The Hmf file that is read in by PCWI_FIX_HEADERS has five SPACE
...
;	2014-SEP-24	removed cwave and gratanom calc: moved to pcwi_format_info.pro
;	2014-OCT-16	now updates headers only once, added update keyword
;-
pro pcwi_fix_headers,hmf,froot=froot,fdigits=fdigits,update=update, $
	verbose=verbose
;
; program setup
pre = 'PCWI_FIX_HEADERS'
