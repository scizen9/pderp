; $Id: kfc.pro,v 1.1 2014/10/17 17:44:13 neill Exp $
;
...
;	each bar of the arc spectrum using a third degree approximation
;
; CATEGORY:
...
;
; OUTPUTS:
;	Centcoeff - coefficients of central fit (3rd degree)
;
; INPUT KEYWORDS:
;
; PROCEDURE:
...
for b = 0,119 do begin
	...
	for d = 0, nn do begin
		...
		pcwi_xspec,intspec,subrefspec,ppar,soffset,svalue, $
			/mean,/shift,/pad,/central,plot=ddisplay,label=xslab
		;
