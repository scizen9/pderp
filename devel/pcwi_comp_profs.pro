; $Id: pcwi_comp_profs.pro,v 1.2 2015/02/20 00:11:40 neill Exp $
;+
...
;
pre = 'PCWI_COMP_PROFS'
version = repstr('$Revision: 1.2 $ $Date: 2015/02/20 00:11:40 $','$','')
;
...
while s ge 0 and s lt 24 do begin
	...
	pcwi_legend,flist,linesty=lsty,box=0,charsi=si,thick=lth, $
		/clear,clr_color=!p.background,spac=2.0
	pcwi_legend,rms,box=0,charsi=si,/right, $
		/clear,clr_color=!p.background,spac=2.0
