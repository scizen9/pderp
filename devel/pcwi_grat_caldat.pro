;$Id: pcwi_grat_caldat.pro,v 1.1 2014/11/07 20:01:27 neill Exp $
pro pcwi_grat_caldat
;+
;	pcwi_grat_caldat - get data for calibrating the CWI gratings
;-
geoms = file_search('/Users/neill/pcwi/data/1*/redux/*_geom.save',count=ngeom)
;
; set up vectors
...
;
; print results
forprint,wavmid,gratpos,campos,grat,jd,imgno,textout='pcwi_grat_caldat.txt', $
