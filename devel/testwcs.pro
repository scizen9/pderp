pro testwcs,pcfg,ppar
;+
; testwcs - testing wcs
;-
	pre='TESTWCS'
	icub = pcwi_read_image(pcfg,ppar,'_icube',hdr,stat=stat)
	...
	if nra ne 1 or ndec ne 1 or npa ne 1 then begin
		pcwi_print_info,ppar,pre,'no coords',/error
		return
	endif
	;
	...
	ofil = root + string(pcfg.imgnum,form=i_fmt)+'_wcs.fits'
