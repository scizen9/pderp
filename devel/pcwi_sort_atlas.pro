; $Id: pcwi_sort_atlas.pro,v 1.1 2014/10/17 17:44:13 neill Exp $
;+
; pcwi_sort_atlas - get good atlas lines and output list sorted by wavelength
;
; INPUTS:
...
;-
pro pcwi_sort_atlas,w,f,atw,wran,res,nlines,satw
