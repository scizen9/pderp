;$Id: pcwi_cflat_anal.pro,v 1.1 2014/11/06 01:07:57 neill Exp $
pro pcwi_cflat_anal,imgno
;+
;	pcwi_cflat_anal - analyze continuum flat images for charge transfer
;-
pre = 'PCWI_CFLAT_ANAL'
version = repstr('$Revision: 1.1 $ $Date: 2014/11/06 01:07:57 $','$','')
;
img = mrdfits('image'+strn(imgno)+'.fits',0,hdr,/fscale)
pcwi_map_ccd,hdr,asec,bsec,csec,tsec,namps=namps,trimmed_size=tsz
osx0 = bsec[0,0,0] + 20
osx1 = bsec[0,0,1] - 20
