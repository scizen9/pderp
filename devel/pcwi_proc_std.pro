; $Id: pcwi_proc_std.pro,v 1.5 2015/04/15 12:17:02 neill Exp $
;	copyright 2015 California Institute of Technology
;+
; pcwi_proc_std - process an Oke and Gunn stds table in AB mags
;
; inputs:
...
;-
pro pcwi_proc_std,ifil,display=display
	;
	; setup
	pre = 'PCWI_PROC_STD'
	version = repstr('$Revision: 1.5 $ $Date: 2015/04/15 12:17:02 $','$','')
	q=''
	;
	; get input units
